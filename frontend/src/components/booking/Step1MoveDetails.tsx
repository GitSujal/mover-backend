                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                            ...
                            <Input id="pickup" placeholder="Enter pickup address" defaultValue={defaultValues?.pickup} required />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="dropoff">Dropoff Address</Label>
                            <Input id="dropoff" placeholder="Enter dropoff address" defaultValue={defaultValues?.dropoff} required />
                        </div>
                    </div>
