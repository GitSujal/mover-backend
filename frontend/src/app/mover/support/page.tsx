...
export default function SupportPage() {
    const [tickets, setTickets] = useState<SupportTicketListResponse | null>(
        null
    );
    const [selectedTicket, setSelectedTicket] =
        useState<SupportTicketWithComments | null>(null);
    ...
    const handleResolveTicket = async () => {
        ...
        const refundStr = prompt(
            "Enter refund amount (or leave blank for no refund):"
        );
                                    ...
                                    {selectedTicket.refund_amount && (
                                        <div>
                                            ...
                                            <p className="text-lg font-bold text-green-600">
                                                $
                                                {selectedTicket.refund_amount.toFixed(
                                                    2
                                                )}
                                            </p>
                                        </div>
